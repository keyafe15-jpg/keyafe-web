...
import { useAdminFlavours, useUpdateFlavour, type AdminFlavour } from "@/hooks/useFlavours";
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Master flavour list. The <span className="font-medium">Additional amount</span> is added
          on top of the product base price (per pound) whenever a customer picks this flavour.
        </p>
      </div>
